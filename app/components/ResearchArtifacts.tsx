...
function Sticky({
  ...
  return (
    <div
      ...
      className={`rounded-lg border shadow-sm font-medium leading-snug ${
        small ? "text-xs px-2.5 py-2" : "text-xs px-3 py-2.5"
      }`}
    >
      {text}
    </div>
...
function ArtifactShell({
  ...
  return (
    ...
    >
      <div
        className="flex items-center gap-2 px-4 py-2.5 border-b border-gray-200"
        style={{ backgroundColor: a.bar }}
      >
        <div className="flex gap-1.5">
          <span
            className="w-2.5 h-2.5 rounded-full"
            style={{ backgroundColor: a.dot1 }}
          />
          <span
            className="w-2.5 h-2.5 rounded-full"
            style={{ backgroundColor: a.dot2 }}
          />
          <span
            className="w-2.5 h-2.5 rounded-full"
            style={{ backgroundColor: a.dot3 }}
          />
        </div>
...
// 1. Clinical workflow map

export function ClinicalWorkflowMap() {
  const moments = [
    {
      label: "Pre-exam prep",
      pain: "Pulls up yesterday's notes mentally",
      n: "01",
    },
    {
      label: "Exam room",
      pain: "Split attention: patient + chart",
      n: "02",
    },
    {
      label: "Between visits",
      pain: "Memory fades, backlog grows",
      n: "03",
    },
    {
      label: "Workstation review",
      pain: "Rebuilds encounter from fragments",
      n: "04",
    },
    {
      label: "After-hours catch-up",
      pain: "1 to 3 hrs of home charting nightly",
      n: "05",
    },
  ];
  ...
  return (
    <ArtifactShell
      label="Clinical Workflow Map, 5 documentation moments"
      accent="purple"
    >
      <p className="text-xs text-gray-400 mb-4">
        Research with 20 clinicians across primary care &amp; specialty,
        mapped where documentation broke down
      </p>
        ...
        {moments.map((m, i) => (
          <div key={m.label} className="flex items-start min-w-0">
            <div className="flex flex-col items-center min-w-[130px]">
              <div
                className="w-10 h-10 rounded-full flex items-center justify-center text-xs font-black mb-2 shrink-0"
                style={{
                  background: "#f3eeff",
              ...
              <p className="text-xs font-semibold text-gray-800 text-center mb-1 leading-tight">
                {m.label}
              </p>
      ...
      >
        <p
          ...
          style={{ color: "#240046" }}
        >
          Key insight: Documentation wasn't one problem; it broke differently
          at each moment. A single recording screen couldn't address all five
          workflow breakdowns, so the solution needed to support the entire
...
export function AmbientAffinityMap() {
  return (
    <ArtifactShell
      label="Interview Synthesis, Affinity Map · 20 clinicians"
      accent="purple"
    >
      <p className="text-xs text-gray-400 mb-4">
        Themes clustered from 45–60 min sessions · Primary care + specialty
        practices
      </p>
        ...
        {[
          {
            ...
            stickies: [
              "Visit context gone by next patient",
              "Had to re-read notes twice",
              "Losing thread mid-consult",
              "Interruptions reset memory",
            ],
          },
          {
            cluster: "Memory & Recall",
            color: "blue" as ColorKey,
            stickies: [
              "Codes + modifiers + chart simultaneously",
              "After-hours = reconstruction",
              "7–8 hrs/week re-charting",
              "Morning backlog anxiety",
            ],
          },
          {
            cluster: "Trust & Verification",
            color: "yellow" as ColorKey,
            stickies: [
              "Need to see what AI drafted",
              "Who is responsible for the note?",
              "Didn't trust invisible transfer",
              "Want to approve each section",
            ],
          },
          {
            cluster: "Transfer Anxiety",
            color: "orange" as ColorKey,
            stickies: [
              "Did it reach the chart?",
              "Partial transfer = re-work",
              "No visibility on failure",
...
export function AmbientWireframes() {
  return (
    <ArtifactShell
      label="Wireframe Exploration, Key screens"
      accent="purple"
    >
      <p className="text-xs text-gray-400 mb-5">
        Core interaction decisions: consent as explicit act · visible
        recording state · section-level transfer
      </p>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 text-center mt-2 leading-tight">
            Consent is explicit, clinician initiates recording
          </p>
        </div>
        ...
        <div>
            ...
            <div className="flex-1 flex flex-col gap-2 px-1">
              ...
              <div className="flex justify-center gap-2">
                {["Recording", "Paused", "Generating", "Sent"].map((s) => (
                  <div
                    key={s}
                    className="text-[7px] text-gray-400 text-center"
                  >
                    <div
                      className={`w-4 h-4 rounded-full mx-auto mb-0.5 border ${
                        s === "Recording"
          ...
          <p className="text-xs text-gray-400 text-center mt-2 leading-tight">
            4 explicit states, clinician always knows what AI is doing
          </p>
        </div>
        ...
        <div>
          ...
          <div className="bg-gray-50 rounded-xl border border-gray-200 p-3 aspect-[4/5] flex flex-col gap-2">
            ...
            <div className="flex-1 flex flex-col gap-1.5 px-1">
              {[
                ...
                <div
                  key={row.label}
                  className="bg-white rounded-lg border border-gray-200 p-2 flex items-center justify-between gap-1"
                >
          ...
          <p className="text-xs text-gray-400 text-center mt-2 leading-tight">
            Section-level status, clinician sees exactly what reached the chart
          </p>
        </div>
      </div>
    </ArtifactShell>
...
export function AmbientProductOverview() {
  return (
    <ArtifactShell
      label="Product Overview, Ambient in athenaOne"
      accent="purple"
    >
      <p className="text-sm text-gray-400 mb-6">
        End-to-end flow: Schedule → Consent → Record → Review → Transfer
      </p>
      ...
      <div className="grid grid-cols-6 items-start gap-3 mb-6">
        {[
          {
            step: "Schedule",
            sub: "Ambient entry point per visit",
            color: "gray" as ColorKey,
            n: "01",
          },
          {
            step: "Consent",
            sub: "Explicit clinician action",
            color: "purple" as ColorKey,
            n: "02",
          },
          {
            step: "Record",
            sub: "Pause/resume visible",
            color: "purple" as ColorKey,
            n: "03",
          },
          {
            step: "AI Draft",
            sub: "Structured by section",
            color: "blue" as ColorKey,
            n: "04",
          },
          {
            step: "Review",
            sub: "Clinician approves each",
            color: "yellow" as ColorKey,
            n: "05",
          },
          {
            step: "Transfer",
            sub: "Status + recovery path",
          ...
          >
            <div
              ...
              style={{
                ...
                borderColor: COLORS[s.color].border,
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          {
            label: "Design rule",
            val: "AI assists, clinician owns the outcome",
            color: "purple" as ColorKey,
          },
          {
            label: "Trust mechanism",
            val: "Explicit approval at every hand-off",
            color: "blue" as ColorKey,
          },
          {
            label: "Recovery",
            val: "Visible failure + clear next action",
            color: "green" as ColorKey,
          },
        ].map((d) => (
          <div
            ...
            style={{
              background: COLORS[d.color].bg,
              borderColor: COLORS[d.color].border,
            }}
          >
            <p
              className="text-xs font-bold uppercase tracking-wide mb-1.5"
              style={{ color: COLORS[d.color].text }}
            >
              {d.label}
            </p>
...
export function BPOShadowingMap() {
  ...
  const themes = [
    ...
    },
    {
      ...
      stickies: [
        "Codes + modifiers + rules + SLA in parallel",
        "High variation between coders",
      ],
      color: "yellow" as ColorKey,
    },
    {
      ...
      stickies: [
        "Changed fields leave no reason",
        "Reviewers reconstruct after the fact",
      ],
      color: "blue" as ColorKey,
    },
  ];
  ...
  return (
    <ArtifactShell
      label="Shadowing Observations · 8 coders · Live workflow sessions"
      accent="blue"
    >
      ...
      <div className="flex flex-col gap-3">
        {themes.map((g) => (
          <div
            ...
            style={{
              border: `1.5px solid ${COLORS[g.color].border}`,
            }}
          >
            <div
              className="flex items-center gap-3 px-4 py-3"
              style={{ backgroundColor: COLORS[g.color].bg }}
            >
              <div
                className="w-7 h-7 rounded-lg flex items-center justify-center text-xs font-black shrink-0"
                style={{
                  backgroundColor: "white",
                  color: COLORS[g.color].text,
                  border: `1px solid ${COLORS[g.color].border}`,
                }}
              >
                {g.n}
              </div>
              ...
              <div className="flex-1 min-w-0">
                <p
                  ...
                  style={{ color: COLORS[g.color].text }}
                >
                  {g.theme}
                </p>
            ...
            <div className="px-4 py-3 bg-white flex flex-wrap gap-1.5">
              {g.stickies.map((s) => (
                <span
                  ...
                  style={{
                    backgroundColor: COLORS[g.color].bg,
                    color: COLORS[g.color].text,
                    border: `1px solid ${COLORS[g.color].border}`,
                  }}
                >
      ...
      <div
        className="mt-4 pt-4 rounded-xl px-4 py-3 flex items-center gap-3"
        style={{
          backgroundColor: BPO_SOFT,
          border: `1.5px solid ${BPO_BORDER}`,
        }}
      >
        <div
          className="w-1 self-stretch rounded-full shrink-0"
          style={{ backgroundColor: BPO_DARK }}
        />

        <p
          className="text-xs font-semibold leading-relaxed"
          style={{ color: BPO_DARK }}
        >
          All three patterns pointed to the same root cause:{" "}
          <strong>
            the workflow forced coders to carry context that the system could
            carry for them.
          </strong>
        </p>
      </div>
...
function FrameGuide({ n }: { n: 1 | 2 }) {
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col gap-2">
        ...
        {n === 2 && (
          <div
            ...
            style={{
              background: SPOT_BG,
              border: `1.5px solid ${SPOT_BORDER}`,
            }}
          >
      ...
      <div
        className="w-28 shrink-0 rounded-lg p-2.5 flex flex-col"
        style={{
          background: SPOT_BG,
          border: `1.5px solid ${SPOT_BORDER}`,
        }}
      >
        ...
        {n === 1 && (
          <div
            className="mt-3 h-5 w-full rounded text-[7px] font-bold flex items-center justify-center"
            style={{
              background: DARK_NAV,
              color: "white",
            }}
      ...
      <div className="flex-1 flex flex-col gap-2">
        ...
        <div className="mt-2 space-y-1.5">
          {[1, 2, 3].map((i) => (
            ...
            >
              <div
                className="h-1.5 w-14 rounded shrink-0"
                style={{ background: "#e2e8f0" }}
              />
              ...
              <div
                className="h-6 px-2 rounded text-[7px] font-bold flex items-center"
                style={{
                  background: SPOT_BG,
                  color: SPOT,
                  border: `1px solid ${SPOT_BORDER}`,
...
function FrameAdjust() {
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col gap-2">
        <div
          className="h-3 w-32 rounded mb-1"
          style={{ background: "#cbd5e1" }}
        />
        ...
        >
          ...
          <div className="flex flex-wrap gap-1.5">
            {[
              ...
              <div
                key={r}
                className="text-[8px] px-2 py-1 rounded font-medium"
                style={{
                  background: "white",
                  border: `1.5px solid ${SPOT_BORDER}`,
                  color: SPOT,
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3">
        ...
        <div
          className="h-5 px-2 rounded text-[8px] font-semibold flex items-center"
          style={{
            background: "#f1f5f9",
            color: "#64748b",
        ...
        {[
          {
            original: "M54.5",
            coder: "M54.51",
            reason: "Chart specifies lumbar",
          },
          {
            original: "–",
            coder: "25",
            reason: "Separate E/M same day",
          },
          {
            original: "99213",
            coder: "99214",
            reason: "Extended time documented",
          },
        ].map((row, i) => (
          <div
            key={i}
          ...
          >
            <div
              ...
              style={{
                background: "#f8fafc",
                borderBottom: `1px solid ${SPOT_BORDER}`,
              }}
            >
              <div
...
export function BPOWireframeNavigator() {
  ...
  const steps = [
    ...
    {
      title: "Editable decisions",
      body: "Prefilled fields stay editable so the coder can adjust the answer when chart context requires it.",
      frame: <FrameValidate />,
    },
    {
      title: "Capture the change",
      body: "When the coder changes a recommendation, the reason is captured with the decision.",
      frame: <FrameAdjust />,
    },
    {
      title: "Make decisions traceable",
      body: "QA sees the recommendation, final decision, and rationale together without reconstructing the work.",
      frame: <FrameQA />,
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "white",
          borderTop: `1px solid ${SPOT_BORDER}`,
        }}
      >
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            style={{
              background:
                active === 0 ? "#f1f5f9" : SPOT_BG,
              border: `1px solid ${
                active === 0 ? "#e2e8f0" : SPOT_BORDER
              }`,
              cursor:
                active === 0 ? "default" : "pointer",
            }}
          >
            <svg
              width="12"
...
// Keep old exports so page.tsx doesn't break

export function BPOWireframes(_: {
  step: string;
  title: string;
  body: string;
}) {
...
export function BPOQAWireframe() {
  return null;
}
...
export function AthenaTextResearchSynthesis() {
  return (
    <ArtifactShell
      label="Research Synthesis, 116 users · 3 methods"
      accent="blue"
    >
        ...
        {[
          {
            ...
            icon: "📊",
            finds: [
              "Satisfaction avg 2.2/5",
              "73% can't find old messages",
              "Inbox cleanup: manual & slow",
            ],
          },
          {
            method: "Interviews",
            ...
            icon: "🎙",
            finds: [
              "Clinical: urgent msgs buried",
              "Billing: history hard to retrieve",
              "Ops: no availability signals",
            ],
          },
          {
            method: "Amplitude data",
            n: "Behaviour",
            color: "teal" as ColorKey,
            icon: "📈",
            finds: [
              "Scroll-to-find most common path",
              "Threads reopened 3–5× per shift",
              "Bulk delete not attempted once",
            ],
          },
        ].map((m) => (
          <div
            ...
            style={{
              ...
              borderColor: COLORS[m.color].border,
            }}
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <div>
                <p
                  ...
                  style={{ color: COLORS[m.color].text }}
                >
                  {m.method}
                </p>
              ...
              {m.finds.map((f) => (
                ...
                >
                  <span
                    ...
                    style={{ color: COLORS[m.color].dot }}
                  >
                    →
                  </span>
      ...
      <div className="p-3 bg-blue-900 rounded-xl">
        <p className="text-xs font-bold text-blue-200 uppercase tracking-wide mb-1">
          Converging insight across all 3 methods
        </p>

        <p className="text-sm text-white font-medium">
          athenaText worked for sending. It failed at recovery, management,
          and availability, the jobs users needed after the message was sent.
        </p>
      </div>
    </ArtifactShell>
  );
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div>
          <p className="text-xs font-bold text-blue-700 uppercase tracking-wide mb-3">
            ✅ After, Communication control
          </p>

          <div className="space-y-1.5">
            {[
              {
                item: "Search, recover conversations",
                tag: "48% adoption",
              },
              {
                item: "Bulk delete, clean up volume",
                tag: "60% usage",
              },
              {
                item: "Pinning + unread states",
                tag: "Shipped",
              },
              {
                item: "Out-of-office availability",
                tag: "Shipped",
              },
              {
                item: "AI suggested replies",
                tag: "Shipped",
              },
              {
...
export function AthenaTextScreenWireframe({
  label,
  type,
}: {
  label: string;
  type: "search" | "ai-reply" | "emoji" | "preserve";
}) {
  return (
    <div>
                ...
                <div className="p-2 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  <div className="flex gap-1 flex-wrap">
                    {[
                      ...
                      <div
                        key={r}
                        className="text-[8px] px-1.5 py-0.5 bg-white border border-blue-200 rounded text-blue-700"
                      >
                        {r}
                      </div>
                    ))}
...
export function PracticeFilesResearch() {
  return (
    <ArtifactShell
      label="Focus Group Synthesis, 6 users · Real task walkthroughs"
      accent="purple"
    >
      <p className="text-sm text-gray-400 mb-5">
        Participants walked through compliance export, document handoff,
        batch upload, rated friction 1–5 at each step
      </p>

      <div className="grid md:grid-cols-3 gap-3 mb-4">
        {[
          {
            pain: "Finding files was slow",
            score: 4.6,
            detail:
              "No search or filters. Users scanned full lists manually every time.",
          },
          {
            pain: "Bulk work was invisible",
            score: 4.3,
            detail:
              "Every action one-at-a-time. Offboarding teams had no way to act on batches.",
          },
          {
            pain: "Compliance actions undocumented",
            score: 4.8,
            detail:
              "Deletions, downloads, handoffs left no trace. Teams couldn't prove what happened.",
          },
        ].map((p) => (
          <div
            key={p.pain}
          ...
          >
            <div className="flex items-start justify-between gap-2 mb-2">
              ...
              <span
                className="text-sm font-bold rounded-full px-2.5 py-0.5 shrink-0"
                style={{
                  color: "#7c3aed",
      ...
      >
        ...
        >
          Triangulated with support ticket data
        </p>

        <p className="text-base text-white leading-relaxed">
          File management was a top-5 contact driver for Customer Success,
          focus group findings matched real ticket volume.
        </p>
      </div>
    </ArtifactShell>
  );
...
export function PracticeFilesCurrentState() {
  return (
    <ArtifactShell
      label="Current State, Annotated gap audit"
      accent="purple"
    >
            ...
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                {[
                  ...
                  <th
                    key={h}
                    className="text-left px-3 py-2 text-xs text-gray-400 font-semibold"
                  >
                    {h}
                  </th>
                ))}
...
export function PracticeFilesRedesigned() {
  return (
    <ArtifactShell
      label="Redesigned Practice Files, Full workflow"
      accent="purple"
    >
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        <div
        ...
        >
          <div
            ...
            style={{
              backgroundColor: COLORS.purple.border,
            }}
          />

          <div
            className="flex-1 h-6 bg-white rounded flex items-center px-2 gap-1"
            style={{
        ...
        >
          ...
          <div className="flex gap-1 ml-2">
            {["Download", "Delete", "Add note"].map((a) => (
              <div
                key={a}
                className="h-5 px-2 bg-white rounded text-[9px] flex items-center"
                style={{
                  border: `1px solid ${COLORS.purple.border}`,
                  color: "#5b21b6",
                }}
          ...
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              ...
              {[
                ...
                <th
                  key={h}
                  className="text-left px-2 py-2 text-xs text-gray-400 font-semibold"
                >
                  {h}
                </th>
              ))}
          ...
          <tbody>
            {[
              ...
              >
                ...
                <td className="px-2 py-2">
                  <span
                    className={`text-[9px] px-1.5 py-0.5 rounded-full ${row.color}`}
                  >
                    {row.status}
                  </span>
                </td>
